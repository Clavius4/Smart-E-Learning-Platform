...
//CREATE QUIZ
export const createCourseQuiz = async (quizData, token) => {
  const toastId = toast.loading("Creating Quiz...");
  let result = null;

  try {
    const response = await apiConnector("POST", CREATE_QUIZ_API, quizData, {
...
//EDIT QUIZ
export const editCourseQuiz = async (quizData, token) => {
  ...
  try {
    ...
    console.log("EDIT QUIZ API RESPONSE............", response);
