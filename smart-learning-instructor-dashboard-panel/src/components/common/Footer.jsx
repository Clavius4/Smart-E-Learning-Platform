...
// footer data
const BottomFooter = ["Sera ya Faragha", "Sera ya Vidakuzi", "Masharti"];

const Resources = [
  "Makala",
  "Blogu",
  "Karatasi ya Chati",
  "Changamoto za Maswali",
  "Nyaraka",
  "Video",
  // "Workspaces", // If you want to include this, you can translate as: "Sehemu za Kazi"
];

const Plans = ["For students", "Business solutions"];
        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <img src={StudyNotionLogo} alt="" className="object-contain" width={55} height={55} loading="lazy" />
              <h1 className="text-richblack-50 font-semibold text-[16px]">E-KIDS</h1>
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link to='www.vitohub.org' target="__blank" className="text-white hover:underline mr-1"
              >
                VitoTech
              </Link>
            </div>
            <span> © 2025 VitoTech</span>
          </div>
